                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div id="login-box-inner" class="with-heading">
                                ...
                                <form role="form" action="/user/forgot_password_send_mail" method="post">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <br/>
                                            <a href="/user/login_page" id="login-forget-link" class="forgot-link col-xs-12">Back to login</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
