        ...
        <div class="col-lg-12">
            <div class="main-box">
                ...
                <div class="main-box-body clearfix">
                    <form class="form-horizontal" role="form" action="/article/update" method="post" id="current_form">
                        <input type="hidden" name="article_id" value="{{ $_GET['id'] or '' }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <script id="myEditor" name="form_article" type="text/plain" style="width:99%;height:200px;">{{ $article['content'] }}</script>
                            </div>
                        </div>
