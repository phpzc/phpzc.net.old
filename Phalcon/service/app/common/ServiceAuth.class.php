...
/**
 * Class ServiceAuth 接口http请求和授权类
 * @package Hmd\Common
 */
class ServiceAuth
{
    ...
    function accessTokenURL(){ return 'http://servicetest.zhongronghe.com/Hmd/Api/access_token';}

    //目前授权页先直接返回token
    function authorizeURL(){ return 'http://servicetest.zhongronghe.com/Hmd/Api/authorize';}

    //刷新access token 刷新token
    function refreshTokenURL() { return 'http://servicetest.zhongronghe.com/Hmd/Api/refreshToken';}
    /**
    ...
    function getAccessToken($type = 'token')
    {
        ...
        if ( is_array($token) && !isset($token['error']) ) {
            ...
            E("get access token failed." . $token['error']);
        }
