...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) { 
		...
		if (width) {
//			html += 'width:' + _escape(width) + 'px;';
			html += 'width="' + _escape(width) + '" ';//2015 12 28 fengchao 修改
		}
		if (height) {
//			html += 'width:' + _escape(height) + 'px;';
			html += 'height="' + _escape(height) + '" ';//2015 12 28 fengchao 修改
		}
//		html += '"';//2015 12 28 fengchao 修改
		if (title) {
